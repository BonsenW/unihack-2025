        ...
        <div>
            <div className="relative flex justify-center items-center h-screen">
                <div className="relative w-100 h-100">
                    ...
                    <h1 className="text-left relative z-50 left-70 top-20 text-5xl text-black"><b>Lola Smith</b></h1>
                    <p className="text-left relative z-50 left-70 top-30 text-black flex items-center">
